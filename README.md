...
!!! info Here is the main link
	...
	[Book 1A](https://nuri.iksi.or.kr/e-book/ecatalog5.jsp?Dir=757&catimage=&callmode=admin)
	[Book 1B](https://nuri.iksi.or.kr/e-book/ecatalog5.jsp?Dir=758&catimage=&callmode=admin)
...
!!! note Rules
	...
	'이/가' attaches to a noun, indicating that the noun is ht subject of the sentence.
...
#### 안
!!! note Rules
	'안' comes before a ver or an adjective, expressing negation or opposite meaning.

#### ㅂ 불규칙
!!! note Rules
	When a verb stem or an adjective stem ending with 'ㅂ' is followed by a vowel, 'ㅂ' is changed to '우'.
	However, not all verbs and aadjectives that end in 'ㅂ' are irregular.
...
#### -았/었-
!!! note Rules
	'았/었' is combined with a verb or an adjective, describing an actiton or a state in the past.
...
## Vocabulary
### 1. 안녕하세요? 저는 안나예요 - Hi? I am Anna
Korean	|	Hanja	|	English	|	Japanese	|	Mongolia
----:	|	:----	|	------	|	------	|	------
한국 사람	|		|	Korea person	|	かんこくじん	|	солонгос хүн
캐나다 사람	|		|	Canadian person	|		|	
베프남 사감	|		|	Vietnam person	|		|	
미국 사람	|		|	American person	|		|	
프랑스 사감	|		|	French person	|		|	
태국 사람	|		|	Thai person	|		|	
인도네시아 사람	|		|	Indonesian person	|		|	
중국 사람	|		|	Chinese person	|		|	
일본 사람	|		|	Japanese person	|		|	
러시아 사람	|		|	Russian person	|		|	
케냐 사람	|		|	Kenyan person	|		|	
회사원	|		|	Employee	|		|	
...
책	|		|	Book	|		|	Ном
공책	|		|	Notebook	|		|	Дэвтэр
항복	|		|	Korean traditional clothes	|		|	Солонгос үндэсний хувцас
커피	|		|	Coffee	|		|	Кофе
언니	|	---	|	Sister	|	---	|	Эгч
동생	|		|	Little brother (or sister)	|		|	Дүү
누구	|		|	Who	|		|	Хэн
친구	|		|	Friend	|		|	Найз
씨	|		|	Sir (mr, ms, mrs)	|		|	Тухайн хүнийг хүндэтгэн дуудаж буй хэлбэр
제	|		|	My	|		|	Миний
아버지	|		|	Father	|		|	Аав
어머니	|		|	Mother	|		|	Ээж
이름	|		|	Name	|		|	Нэр
학생	|		|	Student	|		|	Сурагч
자기소개	|		|	About me	|		|	Өөрийгөө танилцуулах
...
월	|		|	Month	|		|	Сар
쪽	|		|	Direction	|		|	Зүг
번	|		|	Number (one is for bus numbers)	|		|	Дугаар
호	|		|	House Number	|		|	Тоот
원	|		|	Won	|		|	Вон
---	|	---	|	---	|	---	|	---
형	|		|	Brother	|		|	Ах
...
텔레비전	|		|	Television	|		|	Телевизор
남자	|		|	Male	|		|	Эрэгтэй
의자	|		|	Chair	|		|	Сандал
맞다	|		|	Correct	|		|	Зөв
무슨	|		|	What kind of	|		|	Ямар
세종학당	|		|	Sejonghakdang	|		|	Сэжун Хагдан
이메일	|		|	e-mail	|		|	Мэйл
주소	|		|	Address	|		|	Хаяг
한자어	|		|	Hanja number	|		|	Ханз тоо
수	|		|	Number	|		|	Тоо
층	|		|	Floor	|		|	Давхар
월	|		|	Month	|		|	Сар
쪽	|		|	Direction	|		|	Зүг
번	|		|	Number (one is for bus numbers)	|		|	Дугаар
호	|		|	House Number	|		|	Дугаар, тоот
몇	|		|	How much	|		|	Хэд хичнээн
얼마	|		|	How many	|		|	Хэдэн
전화번호	|		|	Phone number	|		|	Утасны дугаар
카페	|		|	Cafe	|		|	Кафе
식당	|		|	Restaurant	|		|	Хоолны газар
영화관	|		|	Movie theater	|		|	Кино Театр
노래방	|		|	Karaoke	|		|	Караоке
PC 방	|		|	Pc cafe center	|		|	PC
지하	|		|	Basement, underneath	|		|	газар доорхи
...
의자	|		|	Chair	|		|	Сандал
가방	|		|	Bag	|		|	Цүнх
필통	|		|	Pencil case	|		|	Пинал
시계	|		|	clock	|		|	Цаг
앞	|		|	Front	|		|	Урд
뒤	|		|	Back	|		|	Ард
위	|		|	Up	|		|	Дээр
아래(밑)	|		|	Below(bottom)	|		|	Доор
옆(오른쪽)	|		|	Side(right)	|		|	Хажуу(баруун)
옆(왼쪽)	|		|	Side(left)	|		|	Хажуу(зүүн)
사이	|		|	Between	|		|	Хооронд
안	|		|	Inside	|		|	Дотор
밖	|		|	Outside	|		|	Гадна
---	|	---	|	---	|	---	|	---
어휘	|		|	Vocabulary	|		|	Үг
새	|		|	New, birds	|		|	Шинэ, шувуу
단어	|		|	Words	|		|	үг хэллэг
세단어	|		|	New words	|		|	Шинэ үг хэллэг
이	|		|	This	|		|	Энэ
그	|		|	That	|		|	Тэр
저	|		|	There	|		|	Тээр тэр
물건	|		|	Thing	|		|	Зүйл
건너편	|		|	Opposite side	|		|	 Эсрэг тал
맞은편	|		|	Other side	|		|	Нөгөө тал
방	|		|	Room	|		|	Өрөө
침대	|		|	Bed	|		|	Ор
신발	|		|	Shoes	|		|	Гутал
우산	|		|	Umbrella	|		|	Зоонтог
...
#### N + -에게, 한테
!!! note Rules
	'-에게, 한테' attches to the end of a onun, indicating the target that is affected by an action.
...
#### -지 못하다
!!! note Rules
	'-지 않다'는 동사나 형용사와 결합하여 앞의 말이 나타내는 행위를 하지 않거나 상태가 나타나지 않음을 표현할 때 사용해요 '-지 못하다'는 동사와 결합하여 앞의 말이 나타내는 행동을 할 능력이 없거나 행동하는 사람의 뜻대로 되지않음을 표현할 때 사용해요.
